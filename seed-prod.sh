...
# Usage: bash seed-prod.sh

set -e

API="https://zgarage-backend-123289148990.us-central1.run.app"
...
for i in $(seq 0 29); do
  ...
  # If CONCLUIDO, update status step by step
